"""
Example:
    python3 tests/difference/nonparametric/kruskal_wallis.py --csv data/sample_data.csv --group-col group
"""
...
def run(groups: Dict[str, List[float]]):
    return {'test': 'Kruskal-Wallis', 'implemented': False}


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Kruskal-Wallis test on CSV data")
