"""
Example:
    python3 tests/assumption/parametric/normality/shapiro_test.py --csv data/sample_data.csv --group-col group
"""
...
def run(groups: Dict[str, List[float]]):
    return {'test': 'Shapiro-Wilk', 'implemented': False}


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Shapiro-Wilk test on CSV data")
